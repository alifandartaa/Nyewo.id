<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Update Lapangan</h1>
    </div>
</div>
<!--/.row-->
<div class="container">
    <?php foreach ($lapangan as $value) : ?>
        <div class="row">
            <form class="form-signin" method="post" action="<?php echo base_url('admin/updateProcess'); ?>">
                ...
                <input type="text" value="<?php echo $value->field_name; ?>" name="nama" id="inputEmail" class="form-control" placeholder="Nama Lapangan" required autofocus>
